...
public class Activity8 {
    ...
    public void verifyContact() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@id='wpforms-8-field_0']")).sendKeys("Nikhitha");
        driver.findElement(By.xpath("//input[@id='wpforms-8-field_1']")).sendKeys("nikhithagondhi@gmail.com");
